...
class ShadDataTableColumn<T> {
  ...
  /// The width of the column. Defaults to an equal share of the viewport.
    ...
    if (rows.isEmpty) {
      ...
      table = ShadTable(
        ...
        columnSpanExtent: (index) {
          ...
          return columns[index - selectionOffset].extent;
        },
        header: (context, column) {
          if (widget.selectable && column == 0) {
            return ShadTableCell.header(
              height: widget.headerHeight,
              // Tighter than the default cell padding: the column is only
              // wide enough for the checkbox itself.
